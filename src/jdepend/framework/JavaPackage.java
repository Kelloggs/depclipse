...
public final class JavaPackage {
    ...
    public boolean collectCycle(List<JavaPackage> list) {
        ...
        for (Iterator<JavaPackage> i = getEfferents().iterator(); i.hasNext();) {
            JavaPackage efferent = i.next();
    ...
    public List<JavaPackage> getAfferents() {
        return afferents;
    }
    ...
    public List<JavaPackage> getEfferents() {
        return efferents;
    }
