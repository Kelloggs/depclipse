...
public class JDepend {
    ...
    public Collection<JavaPackage> analyze() {
        ...
        for (Iterator<JavaClass> i = classes.iterator(); i.hasNext();) {
            analyzeClass(i.next());
        }
     ...
     */
    public final void analyzeInnerClasses(boolean b) {
     ...
     */
    public final void addPackages(Collection<JavaPackage> packages) {
        for (Iterator<JavaPackage> i = packages.iterator(); i.hasNext();) {
            JavaPackage pkg = i.next();
            addPackage(pkg);
        }
    }
    ...
    public final void setFilter(PackageFilter filter) {
        if (parser != null) {
    ...
    private void analyzeClass(JavaClass clazz) {
        ...
        for (Iterator<JavaPackage> i = imports.iterator(); i.hasNext();) {
            JavaPackage importedPackage = i.next();
